function KeyboardWorm(){
  ...
  this.seekWormTowardsKey = function(aKey){
    var lowerCaseKey = aKey.toLowerCase(); //key is a system variable via https://p5js.org/reference/#/p5/key, toLowerCase via http://www.w3schools.com/jsref/jsref_tolowercase.asp

    if(allTheKeys.includes(lowerCaseKey)){
      //if the key is a valid one, then seek the worm towards it
      this.seekWormTowardsPosition(getCanvasPositionFromKey(lowerCaseKey));
    }
  }
